...
# correlation matrix
library(corrplot)
cols_to_use = c('logerror','taxvaluedollarcnt','structuretaxvaluedollarcnt',
                'landtaxvaluedollarcnt','taxamount')
M <- cor(train[,cols_to_use], use = "na.or.complete")
...
train$tax_rate = train$taxamount/train$taxvaluedollarcnt
with(train[1:2,], prop.test(taxamount, taxvaluedollarcnt))
